...
class CouponUpdateTemplateHandler implements ToolHandlerContract
{
    public function __construct(private readonly CouponService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->updateTemplate((int) $arguments['template_id'], $arguments['name'] ?? null, $arguments['status'] ?? null);
    }
}
